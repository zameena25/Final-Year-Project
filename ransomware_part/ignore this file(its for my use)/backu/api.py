...
_files_scanned = 0          # incremented by monitor hook (see below)
...
def start_scan():
    ...
    global _monitor_thread, _monitoring_active, _scan_start_time
    ...
    _monitor_thread = threading.Thread(target=start_monitoring, daemon=True)
    _monitor_thread.start()

    return jsonify({"success": True, "message": "Monitoring started", "started_at": _scan_start_time})
